...
var moveButton = new Button(0,60,210,30,"Move", colArray[0][0],colArray[0][1], colArray[0][2], canvas);
var gridButton = new GridButton(0,90,210,30,"", colArray[0][0],colArray[0][1], colArray[0][2], canvas);
