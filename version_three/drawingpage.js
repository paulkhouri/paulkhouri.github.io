    ...
    mUp(e){
        if(this.dragging){
            if(Button.shape == "Rectangle"){
                this.objectSet.push(new Rectangle(this.xMouseStart, this.yMouseStart, this.xMouse, this.yMouse, Swatch.colour))
            }else if(Button.shape == "Ellipse"){
                this.objectSet.push(new Ellipse(this.xMouseStart, this.yMouseStart, this.xMouse, this.yMouse, Swatch.colour))
